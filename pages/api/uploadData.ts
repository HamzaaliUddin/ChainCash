...
export default async function uploadData(
    ...
    upload.single('file')(req, res, async (err: any) => {
        ...
        try {
            const { vaultAccountId, commodityname, price, buyer, seller, dueDays, commodityDetails } = req.body;
            ...
            let payload = { ...commoDetails, vaultAccountId, commodityname, price, buyer, seller, dueDays }
