...
import addCapitual from "pages/api/addCapitual";
    ...
    const confirm = async () => {
        try {
            ...
            await addCapitual({
                ...
                price: user?.isAdmin ? (price * visibleModal.amount).toString() : (price * visibleModal.amount * (Number(user?.tier) / 100)).toString(),
                data: visibleModal
            });
